...
import { Settings, MessageSquare, Users, ShieldAlert, Sparkles, MessageCircle, Plus, X, Phone, Calendar, FlaskConical, Database, Sun, Moon } from 'lucide-react';
  ...
  return (
    <main className="h-screen w-screen bg-surface-main flex overflow-hidden font-sans select-none">
      <div className="flex w-full h-full overflow-hidden">
        ...
        {!isFullScreen && (
          <div className="flex flex-col w-[64px] bg-surface-header border-r border-border-subtle items-center py-4 justify-between shrink-0 text-content-secondary select-none">
              ...
              <div className="flex flex-col items-center gap-4 w-full px-2">
                {/* Chats */}
                  <button 
                    ...
                    className={`p-3 rounded-xl flex items-center justify-center transition-all duration-200 cursor-pointer ${
                      activeTab === 'chats' ? 'bg-surface-raised text-brand-green' : 'hover:bg-surface-raised hover:text-content-primary text-content-secondary'
                    }`}
                  ...
                  <button 
                    ...
                    className={`p-3 rounded-xl flex items-center justify-center transition-all duration-200 cursor-pointer ${
                      activeTab === 'database' ? 'bg-surface-raised text-brand-green' : 'hover:bg-surface-raised hover:text-content-primary text-content-secondary'
                    }`}
                    title="Base de Datos Local (Clientes Registrados)"
                  >
                    <Database size={20} />
                  </button>
                  ...
                  <Link 
                    href="/admin/clientes"
                    className="p-3 hover:bg-surface-raised hover:text-content-primary text-content-secondary rounded-xl flex items-center justify-center transition-all duration-200 cursor-pointer"
            ...
            {/* Sección Inferior: Tema + Configuración */}
