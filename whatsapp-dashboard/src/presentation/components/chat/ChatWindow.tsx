  ...
  return (
    <div className="flex h-full w-full bg-surface-main overflow-hidden relative transition-all duration-300 border-none rounded-none shadow-none">
      ...
      {alert5mStr && alert5mStr !== 'Disparando Alerta...' && (
        <div className="absolute top-16 left-1/2 -translate-x-1/2 z-30 bg-[#0b0c0d]/90 border border-amber-500/20 px-4 py-2 rounded-full shadow-2xl flex items-center gap-2 font-mono text-[10px] text-amber-400 backdrop-blur-md animate-in slide-in-from-top-2">
