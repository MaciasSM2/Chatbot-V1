...
export const SearchFilters = ({ onDateChange, startDate, endDate, onClear }: { onDateChange: (type: string, value: string) => void; startDate: string; endDate: string; onClear: () => void }) => {
